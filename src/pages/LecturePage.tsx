...
<div className="container mx-auto p-4">
  ...
  <h1 className="text-2xl font-bold mb-4 text-center sm:text-left">{lecture.name}</h1>
...
<div className=' aspect-video ' >
  ...
  <button
    ...
    className={`w-full sm:w-auto px-4 py-2 rounded ${
      completed ? 'bg-green-500 text-white cursor-not-allowed' : 'bg-blue-500 text-white'
    }`}
    disabled={completed}
  >
